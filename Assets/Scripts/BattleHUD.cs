...
public class BattleHUD : MonoBehaviour
{
    ...
    public static void ShowDamagePopup(Vector3 worldPosition, int damageAmount, bool isPlayer)
    {
        if (_popupDamagePrefab == null)
        {
            Debug.LogError("Chưa cung cấp Popup Damage Prefab cho BattleHUD!");
            return;
        }
        ...
        Color damageColor = isPlayer ? Color.red : Color.cyan;
        Vector3 popupPosition = worldPosition + new Vector3(0f, 2f, 0f);
        popupScript.CreatePopup(popupPosition, damageAmount, damageColor);
