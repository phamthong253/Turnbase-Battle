...
public class CameraFocusManager : MonoBehaviour
{
    ...
    {
        if (caster == null || caster.UnitData == null) return;
        ...
        if (speedLineEffect != null)
        {
            Color lineColor = caster.UnitData.BaseData.cinematicSpeedLineColor;
        ...
        if (colorOverlay != null)
        {
            ...
            Color mainColor = caster.UnitData.BaseData.cinematicBackdropColor;
